...
typedef gboolean (*GtkSignal_BOOL__POINTER_POINTER_INT_INT) (GtkObject *
							     object,
							     gpointer arg1,
							     gpointer arg2,
							     gint arg3,
...
typedef gboolean (*GtkSignal_BOOL__POINTER_POINTER_POINTER_POINTER) (GtkObject
								     * object,
								     gpointer
								     arg1,
								     gpointer
				    ...
				    gpointer func_data, GtkArg * args)
{
  ...
  *return_val = (*rfunc) (object,
			  ...
			  GTK_VALUE_CHAR (args[2]), func_data);
}
			      ...
			      gpointer func_data, GtkArg * args)
{
  ...
  (*rfunc) (object,
	    ...
	    GTK_VALUE_C_CALLBACK (args[0]).func_data, func_data);
}
					 ...
					 gpointer func_data, GtkArg * args)
{
  ...
  (*rfunc) (object,
	    ...
	    GTK_VALUE_C_CALLBACK (args[1]).func_data, func_data);
}
			     ...
			     gpointer func_data, GtkArg * args)
{
  ...
  (*rfunc) (object,
	    GTK_VALUE_INT (args[0]), GTK_VALUE_FLOAT (args[1]), func_data);
}
...
typedef void (*GtkSignal_NONE__NONE) (GtkObject * object, gpointer user_data);
void
			       ...
			       gpointer func_data, GtkArg * args)
{
  ...
  (*rfunc) (object,
	    GTK_VALUE_POINTER (args[0]), GTK_VALUE_INT (args[1]), func_data);
}
...
typedef void (*GtkSignal_NONE__POINTER_POINTER_INT_INT) (GtkObject * object,
							 gpointer arg1,
							 gpointer arg2,
							 gint arg3,
							 gint arg4,
							 gpointer user_data);
void
gtk_marshal_NONE__POINTER_POINTER_INT_INT (GtkObject * object,
					   GtkSignalFunc func,
					   gpointer func_data, GtkArg * args)
{
  GtkSignal_NONE__POINTER_POINTER_INT_INT rfunc;
  rfunc = (GtkSignal_NONE__POINTER_POINTER_INT_INT) func;
  (*rfunc) (object,
	    GTK_VALUE_POINTER (args[0]),
	    GTK_VALUE_POINTER (args[1]),
	    GTK_VALUE_INT (args[2]), GTK_VALUE_INT (args[3]), func_data);
}

typedef void (*GtkSignal_NONE__POINTER_INT_INT_POINTER_INT_INT) (GtkObject *
								 object,
								 gpointer
								 arg1,
								 gint arg2,
								 ...
								 user_data);
void
gtk_marshal_NONE__POINTER_INT_INT_POINTER_INT_INT (GtkObject * object,
						   GtkSignalFunc func,
						   gpointer func_data,
						   GtkArg * args)
{
  GtkSignal_NONE__POINTER_INT_INT_POINTER_INT_INT rfunc;
  rfunc = (GtkSignal_NONE__POINTER_INT_INT_POINTER_INT_INT) func;
  (*rfunc) (object,
	    GTK_VALUE_POINTER (args[0]),
	    GTK_VALUE_INT (args[1]),
	    GTK_VALUE_INT (args[2]),
...
typedef void (*GtkSignal_NONE__INT_POINTER_INT_INT_INT_POINTER) (GtkObject *
								 object,
								 gint arg1,
								 gpointer
								 arg2,
						   ...
						   GtkArg * args)
{
  ...
  (*rfunc) (object,
	    ...
	    GTK_VALUE_INT (args[4]), GTK_VALUE_POINTER (args[5]), func_data);
}
					   ...
					   gpointer func_data, GtkArg * args)
{
  ...
  (*rfunc) (object,
	    ...
	    GTK_VALUE_POINTER (args[1]),
	    GTK_VALUE_INT (args[2]),
	    GTK_VALUE_INT (args[3]), GTK_VALUE_INT (args[4]), func_data);
}
			       ...
			       gpointer func_data, GtkArg * args)
{
  ...
  (*rfunc) (object,
	    GTK_VALUE_INT (args[0]), GTK_VALUE_POINTER (args[1]), func_data);
}
