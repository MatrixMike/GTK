...
/* type entries, generated by maketypes.awk */
  ...
  { "GtkCTreeLineStyle", &GTK_TYPE_CTREE_LINE_STYLE,
    GTK_TYPE_ENUM, _gtk_ctree_line_style_values },
  { "GtkCTreeExpanderStyle", &GTK_TYPE_CTREE_EXPANDER_STYLE,
    GTK_TYPE_ENUM, _gtk_ctree_expander_style_values },
  { "GtkCTreeExpansionType", &GTK_TYPE_CTREE_EXPANSION_TYPE,
    GTK_TYPE_ENUM, _gtk_ctree_expansion_type_values },
  { "GtkDebugFlag", &GTK_TYPE_DEBUG_FLAG,
    GTK_TYPE_FLAGS, _gtk_debug_flag_values },
  { "GtkDestDefaults", &GTK_TYPE_DEST_DEFAULTS,
    GTK_TYPE_FLAGS, _gtk_dest_defaults_values },
  { "GtkTargetFlags", &GTK_TYPE_TARGET_FLAGS,
    GTK_TYPE_FLAGS, _gtk_target_flags_values },
  ...
  { "GtkCornerType", &GTK_TYPE_CORNER_TYPE,
    GTK_TYPE_ENUM, _gtk_corner_type_values },
  ...
  { "GtkFontType", &GTK_TYPE_FONT_TYPE,
    GTK_TYPE_FLAGS, _gtk_font_type_values },
  { "GtkFontFilterType", &GTK_TYPE_FONT_FILTER_TYPE,
    GTK_TYPE_ENUM, _gtk_font_filter_type_values },
  ...
  { "GtkRcFlags", &GTK_TYPE_RC_FLAGS,
    GTK_TYPE_FLAGS, _gtk_rc_flags_values },
  ...
  { "GtkToolbarSpaceStyle", &GTK_TYPE_TOOLBAR_SPACE_STYLE,
    GTK_TYPE_ENUM, _gtk_toolbar_space_style_values },
  ...
  { "GdkICAttributesType", &GTK_TYPE_GDK_IC_ATTRIBUTES_TYPE,
    GTK_TYPE_FLAGS, _gdk_ic_attributes_type_values },
  ...
  { "GdkDragAction", &GTK_TYPE_GDK_DRAG_ACTION,
    GTK_TYPE_FLAGS, _gdk_drag_action_values },
  { "GdkDragProtocol", &GTK_TYPE_GDK_DRAG_PROTOCOL,
    GTK_TYPE_ENUM, _gdk_drag_protocol_values },
  ...
  { "GtkStyle", &GTK_TYPE_STYLE,
    GTK_TYPE_BOXED, NULL },
  { "GtkCTreeNode", &GTK_TYPE_CTREE_NODE,
    GTK_TYPE_BOXED, NULL },
  ...
  { "GdkWindow", &GTK_TYPE_GDK_WINDOW,
    GTK_TYPE_BOXED, NULL },
  { "GdkDragContext", &GTK_TYPE_GDK_DRAG_CONTEXT,
    GTK_TYPE_BOXED, NULL },
